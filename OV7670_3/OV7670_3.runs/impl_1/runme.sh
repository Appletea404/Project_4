...
HD_PWD='/home/jsh-laptop/workspace_ondevice_2/fpga/self_study/OV7670_3/OV7670_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OV_VGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OV_VGA.tcl -notrace
